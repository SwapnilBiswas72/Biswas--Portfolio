export const portfolioData = {
  ...
  education: [
    {
      ...
      cgpa: "3.83/4.00 (Completed 18/33 credits)"
    },
    {
      period: "2019–2023",
  ...
  publications: [
    {
      title:
        "Advancing Skin Lesion Classification: The Role of SAM-Based Segmentation in Enhancing Convolutional Neural Network Performance",
      authors: [
        { name: "S. Biswas" },
        { name: "S. M. M. Raza" },
        { name: "T. H. Nguyen" },
  ...
  under_review: [
    {
      title:
        "Data-Driven Approaches to Personalized Gamification: Recent Advances, Trends and Future Directions",
      journal: "IEEE Transactions on Human-Machine Systems"
    },
    {
      title:
        "Personality-Based Preference Prediction in the Metaverse: From Personality Traits to User Engagement",
  ...
  experience: [
    {
      ...
      courses: [
        ...
        "Mitigated class imbalance via a Conditional Variational Autoencoder (CVAE) to improve VGG-16 classification.",
        "Modernized CVIP software stack by replacing ONCRPC with Flatbuffers for 32/64-bit compatibility.",
        "Built a hybrid image enhancement pipeline for thermographic detection of canine bone cancer."
      ]
    },
    {
    ...
    },
    {
      ...
      courses: [
        "Led a project submitted for government RIC funding—data-driven advisory for agriculture.",
        "Collaborated with physicians to create and validate a CKD dataset for early risk identification.",
        "Compared GNN vs. traditional ML for protein secondary structure prediction."
      ]
    },
    {
      ...
      period: "2023 – 2024",
      courses: ["Developed features, fixed bugs, and wrote unit tests within Agile sprints."]
    },
    {
      position: "Undergraduate Assistant & Grader",
      institution: "United International University, Dhaka",
      period: "2022 – 2023",
      courses: ["Graded assignments and assisted students with coursework and conceptual clarity."]
    }
  ],
  ...
  projects: [
    ...
    },
    {
      ...
      type: "Industry Project",
      description:
        "Tutorials, exam resources, discussion forum, note sharing, simulations, and expert online tutors.",
      domain: ["PHP", "MySQL", "HTML", "JavaScript", "Bootstrap"]
    },
    {
